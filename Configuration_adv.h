...
// Servo deactivation delay
#define SERVO_DEACTIVATION_DELAY 300 // Time in milliseconds

// Servo movement speed adjustment
#define SERVO_SPEED { 5, 5, 5 } // Speed for each servo

// Servo delay after movement
#define SERVO_DELAY_AFTER_MOVE 500 // Time in milliseconds

// Tool change settings
#define TOOLCHANGE_SERVO_DELAY 500 // Time in milliseconds

// Bed leveling settings
#define BED_LEVELING_SERVO_DELAY 500 // Time in milliseconds

// Homing settings
#define HOMING_SERVO_DELAY 500 // Time in milliseconds
